...
class DBIngestionRecord(Base):
    ...
    product_domain = Column(String, nullable=True)
    ...
    consumer_actions = Column(JSON, default=list)
    industry_actions = Column(JSON, default=list)
    ...
    source_checked_date = Column(String, nullable=True)
    notes_evidence = Column(String, nullable=True)
