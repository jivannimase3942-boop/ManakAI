...
def main():
    ...
    print("[*] Extracting standards metadata...")
    extracted_records = extract_standards_portal_metadata(html, url)
    ...
    if extracted_records:
        ...
        print("[-] No records could be extracted. The table structure may have changed, or the application is an SPA without static data.")
